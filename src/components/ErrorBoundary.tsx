    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-[#141414] flex items-center justify-center p-6">
          <div className="bg-[#262626] rounded-[20px] p-8 max-w-sm w-full text-center">
            {/* 错误图标 */}
            <div className="w-14 h-14 rounded-full bg-[#333333] flex items-center justify-center mx-auto mb-4">
            ...
            {import.meta.env.DEV && this.state.error && (
              <div className="mb-6 p-3 bg-[#333333] rounded-lg text-left max-h-32 overflow-auto">
